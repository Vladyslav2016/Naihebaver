...
public class AboutDates {
    ...
    public void dateToString() {
        assertEquals(date.toString(), "Sat Mar 03 14:33:21 EET 1973");
    }
    ...
    public void changingDateValue() {
        ...
        assertEquals(date.toString(), "Sat Mar 03 15:33:21 EET 1973");
    }
    ...
    public void usingCalendarToChangeDates() {
        ...
        assertEquals(cal.getTime().toString(), "Tue Apr 03 15:33:21 EET 1973");
    }
    ...
    public void usingRollToChangeDatesDoesntWrapOtherFields() {
        ...
        assertEquals(cal.getTime().toString(), "Sat Mar 03 15:33:21 EET 1973");
    }

    @Koan
    public void usingDateFormatToFormatDate() {
        String formattedDate = DateFormat.getDateInstance().format(date);
        assertEquals(formattedDate, "3 бер. 1973");
    }
    ...
    public void usingDateFormatToFormatDateFull() {
        ...
        assertEquals(formattedDate, "субота, 3 березня 1973 р.");
    }
    ...
    public void usingDateFormatToParseDates() throws ParseException {
        ...
        assertEquals(date2.toString(), "Sat Jan 01 00:00:00 EET 2000");
